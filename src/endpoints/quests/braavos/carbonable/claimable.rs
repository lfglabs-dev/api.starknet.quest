...
const QUEST_ID: u32 = 107;
const TASK_IDS: &[u32] = &[127, 128, 129, 130, 131];
const LAST_TASK: u32 = TASK_IDS[4];
const NFT_LEVEL: u32 = 38;
...
#[route(
    get,
    "/quests/braavos/carbonable/claimable",
    crate::endpoints::quests::braavos::carbonable::claimable
)]
