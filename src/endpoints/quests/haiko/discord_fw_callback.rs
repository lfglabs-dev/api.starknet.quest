...
#[route(
get,
"/quests/haiko/discord_fw_callback",
crate::endpoints::quests::haiko::discord_fw_callback
)]
pub async fn handler(
    ...
    let quest_id = 29;
    let task_id = 142;
    let guild_id = "1181839548775419934";
    ...
    get_error_redirect(
        error_redirect_uri,
        "You're not part of Haiko's Discord server".to_string(),
    )
}
