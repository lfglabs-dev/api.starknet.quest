...
pub async fn handler(
    ...
    let zklend_id = "1471277033968013316";
    ...
    let params = [
        ...
        (
            "redirect_uri",
            &format!(
                "{}/quests/zklend/twitter_fw_callback?addr={}",
    ...
    loop {
        ...
        if next_token.is_none() || following_ids.contains(&zklend_id.to_string()) {
            break;
        }
    }

    if following_ids.contains(&zklend_id.to_string()) {
